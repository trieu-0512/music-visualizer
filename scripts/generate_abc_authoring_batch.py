...
from abc_creative_gold_v5_156_160 import GOLD_V5_156_160_SPEC_PATCHES
from abc_creative_gold_v5_161_165 import GOLD_V5_161_165_SPEC_PATCHES
from abc_creative_gold_v5_166_170 import GOLD_V5_166_170_SPEC_PATCHES
from abc_creative_gold_v5_171_175 import GOLD_V5_171_175_SPEC_PATCHES
from abc_creative_gold_v5_176_180 import GOLD_V5_176_180_SPEC_PATCHES
...
def creative_spec(profile: SongProfile) -> CreativeSpec | None:
    ...
    if profile.song_id in GOLD_V5_156_160_SPEC_PATCHES:
        payload = {**(payload or {}), **GOLD_V5_156_160_SPEC_PATCHES[profile.song_id]}
    if profile.song_id in GOLD_V5_161_165_SPEC_PATCHES:
        payload = {**(payload or {}), **GOLD_V5_161_165_SPEC_PATCHES[profile.song_id]}
    if profile.song_id in GOLD_V5_166_170_SPEC_PATCHES:
        payload = {**(payload or {}), **GOLD_V5_166_170_SPEC_PATCHES[profile.song_id]}
    if profile.song_id in GOLD_V5_171_175_SPEC_PATCHES:
        payload = {**(payload or {}), **GOLD_V5_171_175_SPEC_PATCHES[profile.song_id]}
    if profile.song_id in GOLD_V5_176_180_SPEC_PATCHES:
        payload = {**(payload or {}), **GOLD_V5_176_180_SPEC_PATCHES[profile.song_id]}
    if profile.song_id in GOLD_V5_181_185_SPEC_PATCHES:
        payload = {**(payload or {}), **GOLD_V5_181_185_SPEC_PATCHES[profile.song_id]}
    if profile.song_id in GOLD_V5_186_190_SPEC_PATCHES:
